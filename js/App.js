        ...
        <div className="resume-container">
            ...
            <div className="resume-grid">
                <div>
                    ...
                    <h4 className="resume-column-title" style={{ marginTop: 40 }}>Education</h4>
                    {data.education.map((edu, i) => (
                        <div key={i} className="resume-item">
                            ...
                            <div className="resume-item-org">{edu.school} • {edu.location}</div>
                            <p className="resume-item-details">{edu.details}</p>
                        </div>
                    ))}
                </div>
                <div>
                    ...
                    <h4 className="resume-column-title" style={{ marginTop: 40 }}>Certifications</h4>
                    {data.certifications.map((cert, i) => (
                        <div key={i} className="resume-item" style={{ marginBottom: 16 }}>
                            <div className="resume-item-header">
                                <span className="resume-item-title">{cert.name}</span>
                                {cert.date && <span className="resume-item-period">{cert.date}</span>}
                            </div>
                            <div className="resume-item-org">{cert.issuer}</div>
                        </div>
                    ))}
                </div>
            </div>
